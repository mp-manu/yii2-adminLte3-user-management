...
class UserManagementModule extends \yii\base\Module
{
	...
	{
		return [
			['icon' => 'angle-double-right', 'label' => UserManagementModule::t('back', 'Users'), 'url' => ['/user-management/user/index']],
			['icon' => 'angle-double-right', 'label' => UserManagementModule::t('back', 'Roles'), 'url' => ['/user-management/role/index']],
			['icon' => 'angle-double-right', 'label' => UserManagementModule::t('back', 'Permissions'), 'url' => ['/user-management/permission/index']],
			['icon' => 'angle-double-right', 'label' => UserManagementModule::t('back', 'Permission groups'), 'url' => ['/user-management/auth-item-group/index']],
			['icon' => 'angle-double-right', 'label' => UserManagementModule::t('back', 'Visit log'), 'url' => ['/user-management/user-visit-log/index']],
